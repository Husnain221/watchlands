...
const ListingItem = () => {
  const listing = {
    ...
    description:
      "A beautiful and modern apartment located in the heart of downtown with stunning city views, close to all amenities.",
    offer: true,
    discountPrice: 2200,
    regularPrice: 2500,
    type: "rent",
  ...
  return (
    <div className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden rounded-xl w-full  sm:max-w-[330px]">
      <Link to="/listing/detail" className="block">
            ...
            {listing.imageUrls.map((url, index) => (
              <SwiperSlide key={index}>
                <img
                  ...
                  className="h-[320px] duration-500 sm:h-[220px] w-full object-cover rounded-t-xl transform group-hover:scale-105 transition-all"
                />
              </SwiperSlide>
            ))}
          </Swiper>
