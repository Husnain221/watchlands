...
const Search = () => {
  ...
  const handleChange = (e) => {
    ...
    if (
      ...
      }); // set parking, furnished or offer
    }
  ...
  const onShowMoreClick = async () => {
    ...
    if (data.length < 9) {
      // if there are less than 9 listings, then there are no more listings to show
      setShowMore(false);
    }
    ...
    <div className="grid grid-cols-1 md:grid-cols-12">
      ...
      <div className="col-span-3 p-7 border-b-2 md:border-r-2 md:min-h-screen">
        <form
          ...
          className="flex flex-col w-full gap-6 p-6 border rounded-lg shadow-md"
        >
          {/* Type Section */}
          <div className="flex flex-col gap-4">
            <label className="whitespace-nowrap font-bold text-md mb-2">
              Type:
            </label>
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="sale" className="text-md">
                  Sale
                </label>
              </div>
              <div className="flex items-center gap-2">
          ...
          {/* Search Button */}
          <button className="bg-slate-700 text-white p-3 rounded-md uppercase font-bold tracking-wide shadow-md hover:shadow-lg transition-all duration-200 ease-in-out transform hover:scale-105">
            Search
          </button>
        </form>
      </div>
