...
const properties = [
  {
    ...
    description:
      'A beautiful country villa with large gardens and modern amenities.',
  },
  {
    id: 2,
    ...
    price: '$1,800/month',
    image:
      'https://i.pinimg.com/736x/93/e1/0e/93e10e06e28a305bbb1f9be260cec04f.jpg',
    description:
      'A sleek apartment in the heart of the city with great views and amenities.',
  },
  {
    id: 3,
    ...
    description:
      'A charming beach house with direct access to the ocean and stunning views.',
  },
  {
    id: 4,
    ...
    price: '$4,500/month',
    image:
      'https://w0.peakpx.com/wallpaper/441/409/HD-wallpaper-3d-house-design-modern-exterior-design-modern-house.jpg',
    description:
      'A high-end penthouse offering unmatched luxury and panoramic city views.',
  },
  {
    id: 5,
    ...
    price: '$1,700/month',
    image:
      'https://e0.pxfuel.com/wallpapers/559/288/desktop-wallpaper-fabulous-unique-home-big-house.jpg',
    description:
      'A lovely suburban home with a spacious garden and family-friendly features.',
  },
];
      ...
      <div className='min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 py-12'>
        <div className='container mx-auto px-6'>
          ...
          <p className='text-lg text-center text-gray-700 mb-10'>
            Discover a variety of properties that fit your lifestyle and
            preferences. Use the filters below to refine your search.
          </p>
